...
import {
  // TableExportUtil, TableElement,
  UnsubscribeOnDestroyAdapter } from '@shared';
...
// import { AssetsInterface } from '@core/models/assets';
// import { MatPaginator } from '@angular/material/paginator';
// import { TableElement } from '@shared';
...
//   dataSource: AssetsInterface[] = [];
//   displayedColumns: string[] = ['id', 'plaque', 'serie', 'model', 'actions',];
...
//   getAssets() {
//     this.assetService.getAll().subscribe((assetsResponse) => {
//       if (assetsResponse) {
